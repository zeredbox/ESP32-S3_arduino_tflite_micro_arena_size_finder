...
Look for the file whose name ends with:

```text
_inferencing.h
```

Copy its filename exactly into the `#include` line. GitHub project names, spaces, and special characters may be converted to underscores in the generated filename.

### 🧠 Declare your tensor-arena size symbol
